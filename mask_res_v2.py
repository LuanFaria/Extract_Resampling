...
nome_base_ndvi = 'BASE_TALHOES_NDVI_FERRARI_J4_2024.shp'
...
def sentinel():
    for filename in os.listdir(PASTA_EXTRACT):
        if filename.endswith('.tif') and len(filename) > 9 and filename[8] == 'S':
...
arquivos_S = [f for f in arquivos if f[8] == 'S']
